    ...
    private static class NoSSLv3SSLSocket extends DelegateSSLSocket {
        ...
        public void setEnabledProtocols(String[] protocols) {
            if (protocols != null && protocols.length == 1 && "SSLv3".equals(protocols[0])) {
                ...
                //Log.e("Enabled Protocols",enabledProtocols.toString());
                if (enabledProtocols.size() > 1) {
                    ...
                    //Log.e("ERROR PROTOCOL","Removed TLSv1 from enabled protocols");
                    //Log.e("ERROR PROTOCOL","ADDED TLSv1.1 from enabled protocols");
                    //Log.e("ERROR PROTOCOL","ADDED TLSv1.2 from enabled protocols");
                    //VolleyLog.d("Removed TLSv1 from enabled protocols");
                    //VolleyLog.d("ADDED TLSv1.1 from enabled protocols");
                    //VolleyLog.d("ADDED TLSv1.2 from enabled protocols");
                } else {
                   // VolleyLog.d("SSL stuck with protocol available for " + String.valueOf(enabledProtocols));
                }
                //Log.e("Enabled Protocols AFTER",enabledProtocols.toString());
