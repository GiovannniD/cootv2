...
import com.cootv.ni.adapters.CommonGridAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Resultados de Búsqueda");
        ...
        tvTitle.setText("Mostrando resultados de : "+query );
